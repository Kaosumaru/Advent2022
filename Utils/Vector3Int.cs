...
namespace Utils
{
    public struct Vector3Int : IEquatable<Vector3Int>, IFormattable
    {
        ...
        public float magnitude { get { return (float)Math.Sqrt((float)(x * x + y * y + z * z)); } }
        ...
        public static Vector3Int Min(Vector3Int lhs, Vector3Int rhs) { return new Vector3Int(Math.Min(lhs.x, rhs.x), Math.Min(lhs.y, rhs.y), Math.Min(lhs.z, rhs.z)); }

        // Returns a vector that is made from the largest components of two vectors.

        public static Vector3Int Max(Vector3Int lhs, Vector3Int rhs) { return new Vector3Int(Math.Max(lhs.x, rhs.x), Math.Max(lhs.y, rhs.y), Math.Max(lhs.z, rhs.z)); }
